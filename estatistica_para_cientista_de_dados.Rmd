...
ggplot(data = frota_sp, aes(x = factor(ano), y = tipo_veiculo, fill = quantidade_total)) +
  geom_tile() +
  labs(title = "Distribuição de Quantidade por Tipo de Veículo e Ano",
       x = "Ano",
       y = "Tipo de Veículo",
